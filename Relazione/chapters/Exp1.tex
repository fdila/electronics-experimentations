\chapter*{Esperimento 1: Timer e LED}
\addcontentsline{toc}{chapter}{Esperimento 1: Timer e LED}

\section*{Obiettivo}
Far lampeggiare un led ad una frequenza stabilita e accendere/spegnere un altro led in base alla pressione di un bottone.

\section*{Svolgimento\footnote{Nella repository è il progetto Exp01}}
